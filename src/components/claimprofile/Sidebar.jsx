  ...
  return (
    <div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start rtl:justify-end">
              <button
                ...
                type="button"
                className="inline-flex items-center p-2 text-sm text-gray-200 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
              >
              ...
              <a href="/allclaims" className="flex ms-2 md:me-24">
                <img
                  src="https://flowbite.com/docs/images/logo.svg"
                  className="h-8 me-3"
                  alt="FlowBite Logo"
                />
                <span className="self-center text-xl text-slate-400 font-semibold sm:text-2xl whitespace-nowrap dark:text-white">
                  Upload.Me
                </span>
              </a>
            </div>
      ...
      <aside
        ...
        aria-label="Sidebar"
      >
        <div className="h-full px-3 pb-4 overflow-y-auto bg-purple-200 dark:bg-gray-800">
